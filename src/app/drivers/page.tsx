...
/** ✅ Fix TS red underline: tuple type (not number[]) */
...
function DriverCard({ data, isUnlocked }: { data: DriverRow; isUnlocked: boolean }) {
  return (
    <motion.a
      ...
      whileHover={{ y: -6 }}
      transition={{ duration: 0.8, ease }} // ✅ slower hover
        ...
        <div className="w-full md:w-auto mt-2 md:mt-0 flex flex-col items-end justify-center h-full">
          {isUnlocked ? (
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, ease }} // ✅ slower
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            transition={{ duration: 0.45, ease }} // ✅ slightly slower
