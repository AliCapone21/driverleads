...
export function ThemeToggle() {
  ...
  if (!mounted) return <div className="w-12 h-6 rounded-full bg-gray-200/50" />
  ...
  return (
    <button
      ...
      className={`
        relative inline-flex h-7 w-12 items-center rounded-full transition-colors duration-300 focus:outline-none border border-transparent
    ...
    >
      ...
      <span
        className={`
          inline-block h-5 w-5 transform rounded-full bg-white shadow-sm ring-0 transition duration-300 ease-in-out relative
